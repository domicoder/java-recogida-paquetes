...
public class BuscarClientes extends javax.swing.JFrame {
    ...
    public void mostrarDatos(){
        listaClientes = conexionMySQL.buscarPorNomApell(tfNomApell.getText());
        dtm = (DefaultTableModel) jtBuscarClientes.getModel();
        dtm.setNumRows(0);

        for (int i=0;i< listaClientes.size(); i++){
            jtBuscarClientes.getColumnModel().getColumn(0).setPreferredWidth(10);
            jtBuscarClientes.getColumnModel().getColumn(1).setPreferredWidth(50);
            jtBuscarClientes.getColumnModel().getColumn(2).setPreferredWidth(50);
            jtBuscarClientes.getColumnModel().getColumn(3).setPreferredWidth(50);
            jtBuscarClientes.getColumnModel().getColumn(4).setPreferredWidth(25);
            jtBuscarClientes.getColumnModel().getColumn(5).setPreferredWidth(150);
            Object [] row = {listaClientes.get(i).getIdCliente(),listaClientes.get(i).getNombre(),listaClientes.get(i).getApellido(),
            listaClientes.get(i).getDireccion(),listaClientes.get(i).getSexo(),listaClientes.get(i).getCorreo()};
            dtm.addRow(row);
        }
    }
    ...
    private void initComponents() {
        ...
        tfNomApell = new javax.swing.JTextField();
        lblIcono = new javax.swing.JLabel();
        jScrollPane1 = new javax.swing.JScrollPane();
        jtBuscarClientes = new javax.swing.JTable();
        ...
        lblRepaq1.setText("Buscar clientes por nombre o apellido");
        jPanel4.add(lblRepaq1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 80, 470, 30));

        lblDescripcion.setFont(new java.awt.Font("Open Sans Extrabold", 1, 16)); // NOI18N
        lblDescripcion.setForeground(new java.awt.Color(255, 255, 255));
        lblDescripcion.setText("Nombre o apellido:");
        jPanel4.add(lblDescripcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 150, 160, 30));
        jPanel4.add(tfNomApell, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 150, 170, -1));

        lblIcono.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/recogidapaquete/images/buscar.png"))); // NOI18N
        jPanel4.add(lblIcono, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 10, 60, 70));

        jScrollPane1.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_ALWAYS);
        jScrollPane1.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);
        jScrollPane1.setAutoscrolls(true);

        jtBuscarClientes.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
        jtBuscarClientes.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID", "Nombre", "Apellido", "Dirección", "Sexo", "Correo"
            }
        ) {
        ...
        jtBuscarClientes.setToolTipText("");
        jtBuscarClientes.setMaximumSize(new java.awt.Dimension(650, 140));
        jtBuscarClientes.setMinimumSize(new java.awt.Dimension(650, 140));
        jtBuscarClientes.setName(""); // NOI18N
        jtBuscarClientes.setPreferredSize(new java.awt.Dimension(780, 140));
        jtBuscarClientes.getTableHeader().setResizingAllowed(false);
        jtBuscarClientes.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(jtBuscarClientes);
        jtBuscarClientes.getAccessibleContext().setAccessibleName("");
        jtBuscarClientes.getAccessibleContext().setAccessibleDescription("");

        jPanel4.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 200, 760, 170));

        jpBuscar.setBackground(new java.awt.Color(0, 80, 255));
        jpBuscar.setForeground(new java.awt.Color(0, 80, 255));
        jpBuscar.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jpBuscar.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseMoved(java.awt.event.MouseEvent evt) {
                jpBuscarMouseMoved(evt);
            }
        });
        ...
        lblBuscar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/recogidapaquete/images/search2.png"))); // NOI18N
        ...
        jpBuscar.add(lblBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 120, 40));

        jPanel4.add(jpBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 140, 140, -1));
    ...
    private void lblBuscarMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblBuscarMouseMoved
        jpBuscar.setBackground(new Color(0,0,255));
        jpBuscar.setForeground(new Color(0,0,255));
    ...
    private void lblBuscarMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblBuscarMouseExited
        jpBuscar.setBackground(new Color(0,80,255));
        jpBuscar.setForeground(new Color(0,80,255));
    }//GEN-LAST:event_lblBuscarMouseExited

    private void jpBuscarMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jpBuscarMouseMoved
        jpBuscar.setBackground(new Color(0,0,255));
        jpBuscar.setForeground(new Color(0,0,255));
    }//GEN-LAST:event_jpBuscarMouseMoved
    ...
    private void lblBuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblBuscarMouseClicked
        try {
            ...
            JOptionPane.showMessageDialog(null, "Dato no encontrado u ocurrió un error en el proceso.\n"+e, "ERROR", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private javax.swing.JTable jtBuscarClientes;
    ...
    private javax.swing.JTextField tfNomApell;
