 ...
 */
public class GenCorreo extends javax.swing.JFrame {
    ...
    public int parametros(){
        ...
        if(tfUsuario.getText().isEmpty()){
            validate = 1;
        }else if(tfFechaEspecifica.getText().isEmpty()){
            validate = 1;
        }
        return validate;
    }
    ...
    public String validarFecha(){
       ...
       Matcher encaja = pattern.matcher(tfFechaEspecifica.getText());
       
       if(tfFechaEspecifica.getText()!= signoValidar){
           if(!encaja.find()){
               JOptionPane.showMessageDialog(null,"La fecha no es válida. Debe ser en formato: DD/MM/YYYY", "ERROR", JOptionPane.ERROR_MESSAGE);
           }else{
               validadFecha = tfFechaEspecifica.getText();
           }
       }
       return validadFecha; 
    }
    ...
    private void initComponents() {
        ...
        tfFechaEspecifica = new javax.swing.JTextField();
        ...
        lblCrearReceptor.setText("Generar Correo");
        jPanel4.add(lblCrearReceptor, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 140, -1, 50));
        ...
        lblContrasena.setText("Fecha específica:");
        jPanel5.add(lblContrasena, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 20, 170, 30));

        lblUsuario.setFont(new java.awt.Font("Open Sans Extrabold", 1, 16)); // NOI18N
        lblUsuario.setForeground(new java.awt.Color(255, 255, 255));
        lblUsuario.setText("Usuario de Cliente:");
        jPanel5.add(lblUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 20, 170, 30));

        tfFechaEspecifica.setText("Fecha - 11/11/2018");
        tfFechaEspecifica.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tfFechaEspecificaMouseClicked(evt);
            }
        });
        jPanel5.add(tfFechaEspecifica, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 50, 230, -1));
        ...
        jPanel5.add(tfUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 50, 230, -1));

        jPanel4.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 200, 730, 130));

        lblIcono.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/recogidapaquete/images/email.png"))); // NOI18N
        jPanel4.add(lblIcono, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 70, 70, 70));
        ...
        lbAddCliente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/recogidapaquete/images/gen.png"))); // NOI18N
        lbAddCliente.setText("Generar Correo");
    ...
    private void tfFechaEspecificaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tfFechaEspecificaMouseClicked
        tfFechaEspecifica.setText("");
    }//GEN-LAST:event_tfFechaEspecificaMouseClicked

    private void lbAddClienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbAddClienteMouseClicked
        RecogerPaquete recogerPaquete = new RecogerPaquete();
        MediadorConcreto mediador = new MediadorConcreto();
        Correo correo = new Correo();
        
        if(parametros()==0){  
            conexionMySQL.buscarCorreo(tfUsuario.getText(), correo);
            recogerPaquete.enlazarObserver(correo);
            recogerPaquete.setFechaEspecifica(tfFechaEspecifica.getText());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GenCorreo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField tfFechaEspecifica;
