...
public class BuscarPaquetePorEstados extends javax.swing.JFrame {
    ...
    public BuscarPaquetePorEstados() {
        initComponents();
        this.setLocationRelativeTo(null);
        conexionMySQL = ConexionMySQL.getInstance();
        listaPaquete = new ArrayList<Paquete>();
    ...
    public void mostrarPaquete(){
        ...
        Disponible disponible1 = new Disponible();
        Entregado entregado = new Entregado();
        
        int estados = cbxEstado.getSelectedIndex();
        
        if(estados==1){
            paquete.setEstado(disponible1);
            paquete.ejecutarAccion();
        }else if (estados==2){
            paquete.setEstado(entregado);
            paquete.ejecutarAccion();
        }else if(estados==0){
            JOptionPane.showMessageDialog(null,"Tienes que selecionar Disponible o Entregado.", "ERROR", JOptionPane.ERROR_MESSAGE);
        }
        
        dtm = (DefaultTableModel) jtBuscarPorEstado.getModel();
        listaPaquete = conexionMySQL.getPaqueteEstado(paquete);
        dtm.setNumRows(0);
        
        for(int i=0; i < listaPaquete.size(); i++){
            Object [] row = {listaPaquete.get(i).getDescripcion(),listaPaquete.get(i).getTipoPaquete(),listaPaquete.get(i).getEstadoValido(),
            listaPaquete.get(i).getFecha(), listaPaquete.get(i).getUbicacion()};
            dtm.addRow(row);
        }
    }
    ...
    private void initComponents() {
        ...
        jtBuscarPorEstado = new javax.swing.JTable();
        ...
        lblRepaq1.setText("Buscar paquetes por estado ");
        jPanel4.add(lblRepaq1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 80, 350, 30));

        lblDescripcion.setFont(new java.awt.Font("Open Sans Extrabold", 1, 16)); // NOI18N
        lblDescripcion.setForeground(new java.awt.Color(255, 255, 255));
        lblDescripcion.setText("Estado:");
        jPanel4.add(lblDescripcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 130, 70, 30));

        lblIcono.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/recogidapaquete/images/buscarROJO.png"))); // NOI18N
        jPanel4.add(lblIcono, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 10, 70, 70));

        jScrollPane1.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_ALWAYS);
        jScrollPane1.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);

        jtBuscarPorEstado.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
        jtBuscarPorEstado.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Descripción", "Tipo Paquete", "Estado", "Fecha", "Ubicación"
            }
        ) {
        ...
        jtBuscarPorEstado.getTableHeader().setResizingAllowed(false);
        jtBuscarPorEstado.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(jtBuscarPorEstado);

        jPanel4.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 180, 760, 190));
        ...
        jPanel4.add(jpBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 120, 140, -1));

        cbxEstado.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Estado", "Disponible", "Entregado" }));
        jPanel4.add(cbxEstado, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 130, 170, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarPaquetePorEstados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscarPaquetePorEstados().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jtBuscarPorEstado;
